function pyramidBuilder(data, target, options) {
    ...
    var margin = {
        ...
        sectorWidth = ((w / 2) - margin.middle)-28,
    ...
    leftBarGroup.selectAll('.bar.left')
        ...
        .on("mouseover", function(d) {
            tooltipDiv.transition()
                .duration(200)
                .style("opacity", 0.9);
            tooltipDiv.html("<strong>   Employment Rate in " + d.age + "</strong>" +
                    "<br />  Population: " + prettyFormat(d.male) +
                    "<br />" + (Math.round(percentage(d.male) * 1000) / 10) + "% of Total Population of this cat")
    ...
    rightBarGroup.selectAll('.bar.right')
        ...
        .on("mouseover", function(d) {
            tooltipDiv.transition()
                .duration(200)
                .style("opacity", 0.9);
            tooltipDiv.html("<strong> Illiteracy Rate in " + d.age + "</strong>" +
                    "<br />  Population: " + prettyFormat(d.female) +
                    "<br />" + (Math.round(percentage(d.female) * 1000) / 10) + "% of Total Population of this cat")
                .style("left", (d3.event.pageX) + "px")
                .style("top", (d3.event.pageY - 28) + "px");
        })
        .on("mouseout", function(d) {
